...
**Documentation** tab on this add-on's page) for setup and feature
details.

This same app can also run as a plain standalone Docker container
outside of Home Assistant — see the repository root's `README.md` and
`docker-compose.yml` for that path.
